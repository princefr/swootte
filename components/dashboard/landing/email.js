        ...
        <section className="text-gray-600 body-font relative">
            <div className="container px-5 py-24 mx-auto flex sm:flex-nowrap flex-wrap">
                <div className="lg:w-2/3 md:w-1/2 bg-gray-300 rounded-lg overflow-hidden sm:mr-10 p-10 flex items-end justify-start relative">
                    <iframe width="100%" height="100%" className="absolute inset-0" frameBorder="0" title="map" marginHeight="0" marginWidth="0" scrolling="no" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2625.8948899151005!2d2.283497815673753!3d48.84114357928586!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x47e6700dea9c2253%3A0xeba2f0bce1fa3bd4!2s135%20Rue%20de%20Lourmel%2C%2075015%20Paris!5e0!3m2!1sfr!2sfr!4v1633621436814!5m2!1sfr!2sfr"></iframe>
                    <div className="bg-white relative flex flex-wrap py-6 rounded shadow-md">
                        <div className="lg:w-1/2 px-6">
                            <h2 className="title-font font-semibold text-gray-900 tracking-widest text-xs">ADRESSE</h2>
                            <p className="mt-1">135 Rue de Lourmel, Paris</p>
                        </div>
