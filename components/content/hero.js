      ...
      <div className="flex flex-col items-center justify-between w-full mb-10 lg:flex-row">
        <div className="mb-16 lg:mb-0 lg:max-w-lg lg:pr-5">
          <div className="max-w-xl mb-6">
            <div>
              <button href="#" className="flex bg-roud mt-4 py-1 px-4 mb-4  text-xs text-white rounded lg:rounded-full">
                Environement • • • We are still running on the test serveur
            ...
            <h2 className="font-sans text-4xl font-bold tracking-tight text-gray-900 sm:text-4xl sm:leading-none max-w-lg mb-6">
              Accept digital dollar
              <br className="hidden md:block" />
              for your physical{' '}
              <span className="inline-block relative">
                
                <span className="relative block text-roud">commerce</span>
                </span>
            </h2>
        ...
        <div className="flex items-center relative justify-center lg:w-1/2">
            ...
            <img className="object-cover rounded-full" src="images/contactless-payment-with-smartwatch-technology.jpg" alt="" />
            </div>
        </div>
      </div>
      <a
