    ...
    return (
        <div>
            ...
            <div className="flex flew-row px-16 justify-center mt-10 font-sm">These Swootte Terms of Use is entered into between you (hereinafter referred to as “you” or “your”) and Swootte operators (as defined below). By accessing, downloading, using or clicking on “I agree” to accept any Swootte Services (as defined below) provided by Swootte (as defined below), you agree that you have read, understood and accepted all of the terms and conditions stipulated in these Terms of Use (hereinafter referred to as “these Terms”) as well as our Privacy Policy at www Swootte.com/privacy. In addition, when using some features of the Services, you may be subject to specific additional terms and conditions applicable to those features.
                Please read the terms carefully as they govern your use of Swootte Services.THESE TERMS CONTAIN IMPORTANT PROVISIONS INCLUDING AN ARBITRATION PROVISION THAT REQUIRES ALL CLAIMS TO BE RESOLVED BY WAY OF LEGALLY BINDING ARBITRATION.The terms of the arbitration provision are set forth in Article 10, “Resolving Disputes: Forum, Arbitration, Class Action Waiver”, hereunder. As with any asset, the values of Digital Currencies (as defined below) may fluctuate significantly and there is a substantial risk of economic losses when purchasing, selling, holding or investing in Digital Currencies and their derivatives.BY MAKING USE OF Swootte SERVICES, YOU ACKNOWLEDGE AND AGREE THAT: (1) YOU ARE AWARE OF THE RISKS ASSOCIATED WITH TRANSACTIONS OF DIGITAL CURRENCIES AND THEIR DERIVATIVES; (2) YOU SHALL ASSUME ALL RISKS RELATED TO THE USE OF Swootte SERVICES AND TRANSACTIONS OF DIGITAL CURRENCIES AND THEIR DERIVATIVES; AND (3) Swootte SHALL NOT BE LIABLE FOR ANY SUCH RISKS OR ADVERSE OUTCOMES.
                By accessing, using or attempting to use Swootte Services in any capacity, you acknowledge that you accept and agree to be bound by these Terms. If you do not agree, do not access Swootte or utilize Swootte services.
            </div>

            <div className="px-16 mt-5 font-semibold">I. Definitions</div>
            <div className="px-16 mt-5"><span className="font-semibold">1. Swootte</span> refers to an ecosystem comprising Swootte websites (whose domain names include but are not limited to https://www.swootte.com), mobile applications, clients, applets and other applications that are developed to offer Swootte Services, and includes independently-operated platforms, websites and clients within the ecosystem (e.g. Swootte’s Open Platform, Swootte Launchpad, Swootte Labs, Swootte Charity, Swootte DEX, Swootte X, JEX, Trust Wallet, and fiat gateways). In case of any inconsistency between relevant terms of use of the above platforms and the contents of these Terms, the respective applicable terms of such platforms shall prevail.</div>
