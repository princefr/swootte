...
function RemoveProductConfirm({handleCloseConfirmation, productid, firebaseUID}){
                ...
                <div className="flex items-end justify-center min-h-screen pt-4 px-4 pb-2 text-center sm:block sm:p-0">
                  ...
                  <div className="inline-block align-bottom bg-white rounded-xl text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full">
                      ...
                      <div className="sm:flex sm:items-start">
                        ...
                        <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                          <h3 className="text-lg leading-6 font-medium text-gray-900" id="modal-title">
                            Confirmer la suppréssion du produit
                          </h3>
                          <div className="mt-2">
                            <p className="text-sm text-gray-500">
                              Souhaitez vous vraiment supprimer cet article de votre inventaire ?
                            </p>
                          </div>
                        </div>
                      </div>
                    ...
                    <div className="bg-gray-50 px-4 py-3 sm:px-6 sm:flex sm:flex-row-reverse">
                      <button onClick={handleConfirmRemove} type="button" className="w-full inline-flex justify-center rounded-md border border-transparent shadow-sm px-4 py-2 bg-red-600 text-base font-medium text-white hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500 sm:ml-3 sm:w-auto sm:text-sm">
                        {
