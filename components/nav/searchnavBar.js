    ...
    return (
        <div className="relative inline-block text-gray-600 mx-7">
            <div className="flex h-full w-full">
                <input type="text" value={text} onChange={((e) => setText(e.target.value))} name="text" placeholder="Rechercher: transaction, contact, retrait ..." className="bg-gray-200 h-10 px-5 pr-10 text-sm focus:outline-none focus:ring-2 focus:ring-offset-black focus:ring-black w-96  font-montserrat rounded-full" />
